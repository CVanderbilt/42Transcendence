            ...
            <div class="card-body p-5 text-center">
              <div class="mb-md-5 mt-md-4 pb-9">
                ...
                <p class="small mb-5 pb-lg-2">
                  <a
                    class="text-white-50"
                    href="https://api.intra.42.fr/oauth/authorize?client_id=u-s4t2ud-8b7831bc16e1b149ccb268da713c3705b61d3f9728492946634a9ba532d731fe&redirect_uri=http%3A%2F%2Flocalhost%3A8080%2Flogin&response_type=code"
                    >Login with 42 user</a
                  >
                </p>
